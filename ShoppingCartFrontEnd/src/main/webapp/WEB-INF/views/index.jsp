   ...
   <!-- Wrapper for slides -->
    ...
    <div class="carousel-inner" role="listbox">
      ...
      <div class="item active">
         <img src="<c:url value="/resources/images/furniture12.jpg"/>" alt="Chania" width="600" height="500">
      </div>

      <div class="item">
        <img src="<c:url value="/resources/images/furniture13.jpg"/>" alt="Chania" width="600" height="500">
      </div>
    
      <div class="item">
        <img src="<c:url value="/resources/images/furniture14.jpg"/>" alt="Chania" width="600" height="500"> 
      </div>
